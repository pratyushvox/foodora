...
const SearchPage = () => {
  const { params } = useParams(); // spelling must match your route param
                  ...
                  >
                    ...
                    <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                      <Link to={`/restaurant/${123}`}>
                        <Button className="bg-button hover:bg-button-hover font-semibold rounded-full shadow-md transition-colors duration-200">
                          View Menu
                        </Button>
                      </Link>
                    </CardFooter>
